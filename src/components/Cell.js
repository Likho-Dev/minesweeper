...
//initialising my events on load
...
//event handlers
  ...
  //Adding my flags and size of the flag once revealed
  render() {
    ...
    if (this.props.cell.open) {
      ...
      //Adding different colours to my cells when open depending on the number that is displayed
